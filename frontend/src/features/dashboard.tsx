              ...
              <div className="flex items-center justify-between">
                ...
                {job.status === "done" && (
                  <button
                    ...
                    className="text-xs rounded-md border border-lime/30 bg-lime/[0.10] hover:bg-lime/[0.18] text-lime-200 px-2.5 py-1.5 font-mono uppercase tracking-[0.16em] min-h-[32px]"
                  >
                    Download full CSV
                  </button>
                )}
